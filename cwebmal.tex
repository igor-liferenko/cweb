...
\def\shipout{\let\shipout\oldshipout\afterassignment\myboat\setbox255=}
\def\myboat{\aftergroup\myship}
\def\myship{\global\advance\abspage1\shipout\box255}
...
\def\con{\par\vfill\eject % finish the section names
  ...
  \ifodd\pageno\else
    \advance\pageno by -\abspage % number of first page
    ...
    \ifodd\pageno\else
      ...
      \advance\pageno by\abspage                  % page (stored in DVI file)
      \titletrue\null\vfill\eject
    \fi
  \fi
