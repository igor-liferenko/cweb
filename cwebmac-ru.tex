...
\font\titlefont=omr7 scaled\magstep4 % title on the contents page
\font\ttitlefont=omtt10 scaled\magstep2 % typewriter type in title
\font\tentex=omtex10 % TeX extended character set (used in strings)
...
\def\ATH{{\acrofalse\X\kern-.5em:Определения препроцессора\X}}
...
% \ifodd\pageno\else\titletrue\null\vfill\eject\fi % for duplex printers
  ...
  \line{\hfil Секция\hbox to5em{\hss Страница}} % <-- 3 is changed to 5 because of translation
  \let\ZZ=\contentsline
...
\def\contentsline#1#2#3#4#5{\ifnum#2=0 \smallbreak\fi
    \line{\consetup{#2}#1
      ...
      \ \ifacro\pdflink{#3}{\romannumeral#3}\else#3\fi\hbox to5em{\hss#4}}}
