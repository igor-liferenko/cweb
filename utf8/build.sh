...
# /var/local/bin/cweb-dek/ = original (for test-cweb.sh and test-cwebmac.sh)
...
tie -bhp -c cweav-merged.ch cweave.w $DIR/cweav-utf8.ch $DIR/cweav-sort.ch $DIR/cweav-show.ch $DIR/cweav-n.ch $DIR/cweav-o.ch $DIR/cweav-file.ch $DIR/cweav-mac.ch || exit # ATTENTION: cweav-file.ch must be before cweav-mac.ch
