...
if ! tie -c cweav-merged.ch cweave.w $DIR/cweav-utf8.ch $DIR/cweav-sort.ch $DIR/cweav-nospace.ch $DIR/cweav-prod.ch $DIR/cweav-sub.ch $DIR/cweav-format.ch $DIR/../cweav-blank.ch $DIR/cweav-file.ch $DIR/cweav-mac.ch > build-cweb.out # ATTENTION: cweav-file.ch must be before cweav-mac.ch
  then cat build-cweb.out; exit; fi
...
if ! tie -c ctang-merged.ch ctangle.w $DIR/ctang-utf8.ch $DIR/../ctang-blank.ch $DIR/ctang-file.ch > build-cweb.out
  then cat build-cweb.out; exit; fi
