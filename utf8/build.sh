...
tie -bhp -c comm-merged.ch common.w $DIR/comm-utf8.ch $DIR/comm-file.ch $DIR/comm-exten.ch $DIR/comm-show.ch $DIR/comm-o.ch || exit
...
tie -bhp -c cweav-merged.ch cweave.w $DIR/cweav-utf8.ch $DIR/cweav-sort.ch $DIR/cweav-show.ch $DIR/cweav-o.ch $DIR/cweav-file.ch $DIR/cweav-mac.ch || exit # ATTENTION: cweav-file.ch must be before cweav-mac.ch
...
tie -bhp -c cweav-merged.ch cweave.w $DIR/cweav-sort.ch $DIR/cweav-show.ch || exit
./ctangle -bhp cweave.w cweav-merged.ch || exit
clang -g -w -c cweave.c || exit
clang -g -o cweave cweave.o common.o
