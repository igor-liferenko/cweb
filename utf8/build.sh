...
perl -i -pe 'if(/wchar_t/){print; s/wchar_t/wint_t/; print; s/wint_t/ssize_t/; print; s/ssize_t/uint8_t/; print; s/uint8_t/uint16_t/; print; s/uint16_t/uint32_t/; print; s/uint32_t/cchar_t/; print; s/cchar_t/pid_t/}' cweave.w
