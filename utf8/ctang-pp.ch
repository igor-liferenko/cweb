...
TODO: instead of mcpp use strcmp when new line is read and use the required statements directly in source of ctangle (until you come up with a syntax analyzer) and store all @d in an array and check there and based on this manipulate gobble_section
