...
case minus_minus: myputc('-'); myputc('-');
                  out_state=normal; break;
case minus_gt: myputc('-'); myputc('>');
               out_state=normal; break;
case gt_gt: myputc('>'); myputc('>');
            out_state=normal; break;
case eq_eq: myputc('='); myputc('=');
            out_state=normal; break;
case lt_lt: myputc('<'); myputc('<');
            out_state=normal; break;
case gt_eq: myputc('>'); myputc('=');
            out_state=normal; break;
case lt_eq: myputc('<'); myputc('=');
            out_state=normal; break;
case not_eq: myputc('!'); myputc('=');
             out_state=normal; break;
case and_and: myputc('&'); myputc('&');
              out_state=normal; break;
case or_or: myputc('|'); myputc('|');
            out_state=normal; break;
case dot_dot_dot: myputc('.'); myputc('.'); myputc('.');
                  out_state=normal;
    break;
case colon_colon: myputc(':'); myputc(':');
                  out_state=normal; break;
case period_ast: myputc('.'); myputc('*');
                 out_state=normal; break;
case minus_gt_ast: myputc('-'); myputc('>'); myputc('*');
                   out_state=normal;
    break;
@z
