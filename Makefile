all:
	...
	ctie -c cweav-merged.ch cweave.w common-utf8.ch cweav-utf8.ch cweave+c.ch cweave+d.ch cweave+g.ch cweave+y.ch cweave+z.ch >/dev/null # TODO: check what is +g via dvidiff
