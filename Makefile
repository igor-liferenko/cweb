all:
	...
	tie -c comm-merged.ch common.w common-utf8.ch comm-utf8.ch comm-bhp.ch common-constants.ch comm-constants.ch comm-fclose.ch >/dev/null
	...
	ctie -c ctang-merged.ch ctangle.w common-utf8.ch ctang-utf8.ch ctang-bhp.ch ctangle+u.ch common-constants.ch ctang-constants.ch >/dev/null
