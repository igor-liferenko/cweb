...
\point 5. Define \.{\\pdfhorigin} and \.{\\hoffset} in \CWEB/ file.
...
Call \.{cweave} with the option \.{--duplex}; without this option, setting
\.{\\pdfhorigin} and\.{\\hoffset} is removed from \CWEB/ file. Also, this option
adds defining \.{\\duplex} macro, which is used in \.{cwebmac.tex} to output an empty page
before table of contents, if necessary.
