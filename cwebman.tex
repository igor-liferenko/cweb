...
\pageno=-1 \titletrue\eject\null\vfill\titletrue\eject\pageno=1
...
End-of-line character is not equivalent to a space in this case, because it
causes an unneeded \.{\\Y} and \.{\\4} to be added before and after \.{\\B} respectively
in woven output (see cweb-git/NOTE).
