...
one-letter identifiers (except when these one-letter
identifiers are defined). Such identifiers are felt to be so ubiquitous
...
\def\printmacs{\begingroup
  ...
  \catcode`\ =13 \catcode`\^^M=13
  \tt \verbatimdefs \input cwebmal \endgroup}
\printmacs
\endgroup
\vfill\eject
