...
If you change |max_bytes|, |max_names|, or |buf_size|
...
@<Common code...@>=
char section_text[longest_name+1]; /* section text being sought for */
...
@<Do the first pass...@>= {
int c; /* index into |bucket|; cannot be |eight_bits| because comparison
  below will always be true */
...
eight_bits d;
{
  int c; /* index into |collate|; cannot be |eight_bits| because comparison
    below will always be true */
  for (c=100+128; c>= 0; c--) if (bucket[collate[c]]!=NULL) {
@^high-bit character handling@>
